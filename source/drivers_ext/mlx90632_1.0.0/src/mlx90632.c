...
double mlx90632_preprocess_temp_ambient(int16_t ambient_new_raw, int16_t ambient_old_raw, int16_t Gb)
{
    ...
    return ((ambient_new_raw / (MLX90632_REF_3)) / VR_Ta) * (double)524288.0;
}
                                       ...
                                       int16_t Ka)
{
    ...
    return ((((object_new_raw + object_old_raw) / 2) / (MLX90632_REF_12)) / VR_IR) * (double)524288.0;
}
...
*/
int32_t mlx90632_read_calibration_parameters(int32_t *PR, int32_t *PG, int32_t *PO, int32_t *PT, 
                                             int32_t *Ea, int32_t *Eb, int32_t *Fa, int32_t *Fb,
                                             int32_t *Ga, int16_t *Gb, int16_t *Ha, int16_t *Hb,
                                             int16_t *Ka)
{
    int32_t ret;

    ret = mlx90632_i2c_read_dword(MLX90632_EE_P_R, (uint32_t *) PR);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_P_G, (uint32_t *) PG);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_P_O, (uint32_t *) PO);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_P_T, (uint32_t *) PT);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_Ea , (uint32_t *) Ea);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_Eb , (uint32_t *) Eb);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_Fa , (uint32_t *) Fa);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_Fb , (uint32_t *) Fb);
    if(ret != 0) return ret;
    ret = mlx90632_i2c_read_dword(MLX90632_EE_Ga , (uint32_t *) Ga);
    if(ret != 0) return ret;
