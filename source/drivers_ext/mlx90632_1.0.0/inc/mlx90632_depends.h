...
#define    MLX90632_SCL             ARDUINO_SCL_PIN   //!< Master SCL pin
#define    MLX90632_SDA             ARDUINO_SDA_PIN   //!< Master SDA pin

#define    MLX90632_INSTANCE_ID     0

#define    MLX90632_I2C_ADDR        (0x3b)              //(0x3a << 1)
